...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_main,_Dio_ReadChannel
	FNCALL	_main,_Dio_WriteChannel
	FNROOT	_main
...
?_Dio_WriteChannel:	; 1 bytes @ 0x0
?_main:	; 2 bytes @ 0x0
	global	Dio_WriteChannel@level
Dio_WriteChannel@level:	; 1 bytes @ 0x0
??_Dio_Init:	; 1 bytes @ 0x0
??_Dio_ReadChannel:	; 1 bytes @ 0x0
	ds   1
??_Dio_WriteChannel:	; 1 bytes @ 0x1
	ds   5
	global	Dio_Init@i
Dio_Init@i:	; 1 bytes @ 0x6
	ds   1
	global	Dio_ReadChannel@channelId
Dio_ReadChannel@channelId:	; 1 bytes @ 0x7
	ds   1
	global	Dio_WriteChannel@channelId
Dio_WriteChannel@channelId:	; 1 bytes @ 0x8
	ds   1
??_main:	; 1 bytes @ 0x9
;!
;!Data Sizes:
...
;!
;!    S62$lat	PTR volatile unsigned char  size(2) Largest target is 1
;!		 -> LATB(BIGSFR[1]), LATC(BIGSFR[1]), 
;!
;!    S62$port	PTR volatile unsigned char  size(2) Largest target is 1
;!		 -> PORTB(BIGSFR[1]), PORTC(BIGSFR[1]), 
;!
;!    S62$tris	PTR volatile unsigned char  size(2) Largest target is 1
;!		 -> TRISB(BIGSFR[1]), TRISC(BIGSFR[1]), 
;!
...
;!                   _Dio_WriteChannel
;! ---------------------------------------------------------------------------------
;! (1) _Dio_WriteChannel                                     9     8      1     140
;!                                              0 COMRAM     9     8      1
;! ---------------------------------------------------------------------------------
;! (1) _Dio_ReadChannel                                      8     8      0      30
;!                                              0 COMRAM     8     8      0
;! ---------------------------------------------------------------------------------
...
;; Defined at:
;;		line 33 in file "src/dio.c"
;; Parameters:    Size  Location     Type
;;  channelId       1    wreg     unsigned char 
;;  level           1    0[COMRAM] enum E40
;; Auto vars:     Size  Location     Type
;;  channelId       1    8[COMRAM] unsigned char 
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
;; Registers used:
...
;; Defined at:
;;		line 21 in file "src/dio.c"
;; Parameters:    Size  Location     Type
;;  channelId       1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
;;  channelId       1    7[COMRAM] unsigned char 
;; Return value:  Size  Location     Type
;;                  1    wreg      enum E40
;; Registers used:
;;		wreg, fsr2l, fsr2h, status,2, status,0, tblptrl, tblptrh, tblptru, prodl, prodh
